...
export async function GET(request) {
    try {
        ...
        return NextResponse.json({ error: 'Failed to fetch pump' }, { status: 500 });
    }
}
/**
...
export async function PATCH(request) {
    try {
        ...
        return NextResponse.json({ error: 'Failed to update pump' }, { status: 500 });
    }
}
/**
...
export async function DELETE(request) {
    try {
        ...
        return NextResponse.json({ error: 'Failed to delete pump' }, { status: 500 });
    }
}
